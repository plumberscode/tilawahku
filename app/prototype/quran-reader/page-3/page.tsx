...
export const metadata = {
  title: "Quran Reader Prototype (Page 3) - Tilawahku",
  description: "Prototype Quran Reader Mushaf Madinah QCF V2 (Page 3)",
};

export default async function QuranReaderPage3() {
  const pageData = await getQuranPage(3);
